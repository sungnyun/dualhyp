...
import ger
from ger.adapter import GPT as BaseModel
from ger.adapter import Block as BaseBlock
from ger.adapter import CausalSelfAttention as BaseCausalSelfAttention
from ger.adapter import Config as BaseConfig
from ger.model import KVCache
...
class Config(BaseConfig):
    ...
    def mlp_class(self) -> Type:
        return getattr(ger.adapter_v2, self._mlp_class)
...
class LLaMAMLP(ger.model.LLaMAMLP):
    def __init__(self, config: Config) -> None:
        nn.Module.__init__(self)
