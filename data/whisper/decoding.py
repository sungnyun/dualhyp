...
class DecodingTask:
    ...
    def run(self, mel: Tensor) -> List[DecodingResult]:
        ...
        ###### LipGER style - Length normalization after ordering nhyps, only single sample supported
        ...
        # ##### Robust Hyporadise style - Ordering nhyps after length normalization, multi-sample supported
        ...
        #         tokens=tokens[0],
        #         texts=texts[0],
        #         avg_logprob=scores[0],
        #         no_speech_prob=no_speech_probs[0],
        #         temperature=self.options.temperature,
        #         compression_ratio=compression_ratio(texts[0][0]))
