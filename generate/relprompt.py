...
from ger.tokenizer import Tokenizer
...
def generate(
    ...
    *,
    ...
    # audio_features, visual_features = audio_features.to(device), visual_features.to(device)

    # generate up to a fixed number of tokens
    for _ in range(max_returned_tokens - T):
        x = idx.index_select(0, input_pos).view(1, -1)

        logits = model(x, audio_query=None, lip_query=None, input_pos=input_pos)
